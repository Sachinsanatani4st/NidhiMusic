...
OWNER_ID = list(map(int, getenv("OWNER_ID", "6559138719").split()))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/II_4ST_FIGHTER_ll")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/II_4ST_FIGHTER_ll")
